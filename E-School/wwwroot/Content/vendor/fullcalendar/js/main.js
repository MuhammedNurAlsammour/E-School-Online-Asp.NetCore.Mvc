...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var BASE_OPTION_DEFAULTS = {
        ...
        nowIndicator: false,
        scrollTime: '06:00:00',
        slotMinTime: '09:00:00', // ÊÍÏíÏ æÞÊ ÇáÈÏÁ Åáì ÇáÓÇÚÉ 9 ÕÈÇÍðÇ
        slotMaxTime: '24:00:00', // ÊÍÏíÏ æÞÊ ÇáÇäÊåÇÁ Åáì ãäÊÕÝ Çááíá (12:00 ÕÈÇÍðÇ)
    ...
    */
    ...
    function parse(str) {
        ...
        if (m) {
            var marker = new Date(Date.UTC(Number(m[1]), m[3] ? Number(m[3]) - 1 : 0, Number(m[5] || 1), Number(m[7] || 0), Number(m[8] || 0), Number(m[10] || 0), m[
            ] ? Number("0." + m[12]) * 1000 : 0));
